...
const HABITS = [
  ...
  { id: 'study1',   label: 'Study Block 1 — Full Stack Dev',     icon: '⚛️', cat: 'fullstack' },
  { id: 'study2',   label: 'Study Block 2 — Backend / Node.js',  icon: '🖥️', cat: 'fullstack' },
  { id: 'study3',   label: 'Study Block 3 — Data Analytics',     icon: '📊', cat: 'analytics' },
  { id: 'project',  label: 'Project work done',                  icon: '🛠️', cat: 'project' },
  { id: 'github',   label: 'GitHub commit made',                 icon: '🐙', cat: 'fullstack' },
  { id: 'linkedin', label: 'LinkedIn / Job application done',    icon: '💼', cat: 'jobs' },
];
  ...
  if (loading) return (
    <div className="dt-page">
      <div className="dt-skeleton-grid">
        {[1,2,3,4].map(i => <div key={i} className="dt-skeleton-card" />)}
      </div>
    </div>
  );
    ...
    <div className="dt-page">
      ...
      <div className="dt-grid">
        ...
        <section className="dt-card">
          <div className="sec-title"><Trophy size={12} /> Daily Habits</div>
              ...
              return (
                ...
                >
                  ...
                  <div className="dt-habit-right">
                    ...
                    {done
                      ? <CheckCircle2 size={18} style={{ color: catColor, flexShrink: 0 }} />
                      : <Circle size={18} style={{ color: 'var(--border-2)', flexShrink: 0 }} />
                    }
                  </div>
                </button>
              );
          ...
          <div className="dt-habits-footer">
            <div className="dt-prog-track">
              <div className="dt-prog-fill" style={{ width: `${completionPct}%` }} />
            </div>
        ...
        {/* ── Today's schedule ── */}
        <section className="dt-card">
          <div className="sec-title"><Calendar size={12} /> {dayName}'s Schedule</div>
